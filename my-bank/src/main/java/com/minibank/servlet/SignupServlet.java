...
public class SignupServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        SignupRequest signupRequest =
                mapper.readValue(req.getInputStream(), SignupRequest.class);
        ...
        if (username == null || password == null ||
            ...
            ApiResponse response =
                    new ApiResponse(false, "All fields are required", null);
        ...
        if (password.length() < 6) {
            ApiResponse response =
                    new ApiResponse(false, "Password should be at least 6 characters", null);
            mapper.writeValue(res.getWriter(), response);
            return;
        }
        ...
        ApiResponse response = created
                ? new ApiResponse(true, "User created successfully", null)
                : new ApiResponse(false, "Failed to create user", null);
